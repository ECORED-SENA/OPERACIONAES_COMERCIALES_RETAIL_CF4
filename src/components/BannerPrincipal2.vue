  ...
  .container.tarjeta(
    ...
    .row.banner-principal__row.justify-content-center
      ...
      .d-none.d-lg-block.col-lg-4.px-0.banner-principal__img
        .contenedor-imagenes
          .imagen_flotante.imagen_flotante_1: img(src="@/assets/curso/float1.png")
          .imagen_flotante.imagen_flotante_2: img(src="@/assets/curso/float2.png")
          .imagen_flotante.imagen_flotante_3: img(src="@/assets/curso/float3.png")
